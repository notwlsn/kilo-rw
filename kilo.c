/*** kilo - text editor in C ***/
/*** original project: https://github.com/antirez/kilo ***/
/*** Changes by: gwillson.camp@protonmail.ch ***/

/*** We will be using VT100 escapes throughout the code ***/
